...
function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/update-cart', pizza).then(function (res) {
    ...
    // }),
    //   show();
    toastr__WEBPACK_IMPORTED_MODULE_0___default().success('Item Added to cart Successfully');
  })["catch"](function (err) {
    // new Noty({
    // type:'error',
    // timeout:1000,
    ...
    // }),
    //   show();
    toastr__WEBPACK_IMPORTED_MODULE_0___default().error('Something went wrong');
  });
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["public/css/style"], () => (__webpack_require__("./resources/scss/app.scss")))
